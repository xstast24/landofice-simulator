...
<input value='Svatyně ledu' class='chramy led' type=button onclick='pole("1020 x Vyznavač boha ledu\n112 x Zasvěcenec boha ledu\n103 x Ledový Přízrak\n8 x Ledový obr")'><br>
<input value='Dóm ledu' class='chramy led' type=button onclick='pole("5,119 x Vyznavač boha ledu\n1,071 x Zasvěcenec boha ledu\n501 x Starodávný Ledový Přízrak\n76 x Ledový obr\n44 x Sněžný obr\n210 x Šaman Ledu")'><br>
<input value='Chrám života' class='chramy zivot' type=button onclick='pole("51 x Ent\n78 x Druid\n1 x Lesní obr")'><br>
<input value='Svatyně života' class='chramy zivot' type=button onclick='pole("582 x Ent\n265 x Starodávný ent\n1000 x Druid\n10 x Lesní obr")'><br>
<input value='Dóm života' class='chramy zivot' type=button onclick='pole("2874 x Ent\n1456 x Starodávný ent\n4766 x Druid\n1,406 x Veledruid\n36 x Lesní obr")'><br>
<input value='Chrám ohně' class='chramy ohen' type=button onclick='pole("573 x Mág ohně\n55 x Ohnivý golem\n10 x Ohnivý Fénix\n1 x Flamekeeper\n")'><br>
<input value='Svatyně ohně' class='chramy ohen' type=button onclick='pole("5154 x Mág ohně\n505 x Ohnivý golem\n80 x Magmatický golem\n90 x Ohnivý Fénix\n12 x Flamekeeper\n")'><br>
...
<input value='Ætherův chrám' class='chramy aether' type=button onclick='pole("2000 x Vyznavač boha ledu\n100 x Zasvěcenec boha ledu\n120 x Ledový Přízrak\n25 x Ledový obr\n3 x Ledová hydra")'><br>
<input value='Ætherova svatyně' class='chramy aether' type=button onclick='pole("14100 x Vyznavač boha ledu\n3180 x Zasvěcenec boha ledu\n990 x Ledový Přízrak\n612 x Starodávný ledový přízrak\n159 x Ledový obr\n17 x Ledová hydra\n1 x Velemág ledu")'><br>
<input value='Chrám země' class='chramy zeme' type=button onclick='pole("1170 x Elfí lučištník\n118 x Druid\n2 x Wurm\n1102 x Ent\n480 x Starodávný Ent\n2 x Mág země")'><br>
<input value='Posvátný chrám země' class='chramy zeme' type=button onclick='pole("4528 x Elfí lučištník\n558 x Druid\n300 x Veledruid\n5 x Wurm\n2327 x Ent\n1406 x Starodávný Ent\n5 x Mág země")'><br><br>
...
<br>
    ...
    V případě, že narazíte na jiné chyby, napište do issues na githubu simulatoru: https://github.com/xstast24/landofice-simulator
    <br><br>
    <h4>Credits</h4>
    1) původní autor<br>
    2) Rip - dlouhou dobu vyvíjel a spravoval do 2021 (mengsk@email.cz)<br>
    3) Bota a Healtonn - reinkarnace simulatoru 2022 a development; Hron a Nezmar - informace o jednotkach, herni zkusenosti
<br><br>
</div>
