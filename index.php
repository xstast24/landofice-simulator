...
$utocnik="1 x Velitel 2 (Æthrova róba moci)
2,000 x Ozbrojený vesničan(Gladius)
2000 x ozbrojeny vesnican";
...
<div id='mainContainer' style='text-align: center; font-family: verdana,sans-serif; font-size: 12px; padding-top: 5px'>
    <style type=text/css>
        .centeredContainer {text-align: center; margin: auto}
        table {color: black; font-size: 11px; font-weight: 900}

        #polickaArmady {margin: auto; padding: 1px; text-align: center; Vertical-align: top; color: black}
        ...
        #tabulkaEventu {margin: auto; padding: 1px; text-align: justify; color: black}
        #eventy td {text-align: justify; Vertical-align: top; color: white;}
        ...
        .nadpisSekce {font-style: italic; text-decoration: underline; margin-left: 6px; white-space: nowrap}
        #sekceBonusy {color: gray}
        #sekceCisarskeArmady {color: gray}
    ...
    <div id='ovladaciSekce' class='centeredContainer'>
        <table id='polickaArmady'>
        ...
        <br>
        <input type='submit' onClick="zobrazit()" value="Zobrazit/Skrýt Eventy" class='boj'>
        <br>
    </div>

    <div id="eventy" class='centeredContainer' style='display:none'>
        <table id="tabulkaEventu">
            <tr>
                <td>
                    <div id="sekceEventyZacatky"><a class='nadpisSekce' onclick="simulovatCelouSekci('sekceEventyZacatky')"><b>Eventy - začátky</b></a><br>
                    ...
                    <div id="sekceEventyTrpaslici"><a class='nadpisSekce' onclick="simulovatCelouSekci('sekceEventyTrpaslici')"><b>Eventy - trpaslíci</b></a><br>
                ...
                <td>
                    <div id="sekceValka"><a class='nadpisSekce' onclick="simulovatCelouSekci('sekceValka')"><b>Válka</b></a><br>
                        ...
                        <input value='Chrám Eternanů' type=button onclick='pole("80 x Eternan vyvolávač\n33 x Eternan mág\n2 x Eternan dohlížitel")'><br>
                    </div>
                    <br>


                    <div id="sekceTazeni"><a class='nadpisSekce' onclick="simulovatCelouSekci('sekceTazeni')"><b>Tažení</b></a><br>
                ...
                <td>
                    <div id="sekcePleneniZelene"><a class='nadpisSekce' onclick="simulovatCelouSekci('sekcePleneniZelene')"><b>Plenění zelené</b></a><br>
                        ...
                        <input value='Dralgar - Neprostupný hvozd 1' class='pleneni zelene' type=button onclick='pole("2,500 x Zelený lesní pavouk\n2,500 x Červený lesní pavouk\n2,500 x Černý lesní pavouk\n250 x Zlatý lesní pavouk\n1,000 x Lesní Troll")'><br>
                        <input value='Dralgar - Neprostupný hvozd 2' class='pleneni zelene' type=button onclick='pole("1,500 x Druid\n25 x Lesní obr\n5 x Wurm\n750 x Ent\n500 x Starodávný Ent")'><br>
                        <input value='Dralgar - Zahrady kolem chrámu 1' class='pleneni zelene' type=button onclick='pole("1,500 x Obří zelený pavouk\n1,500 x Obří červený pavouk\n2,500 x Černý lesní pavouk\n500 x Zlatý lesní pavouk\n1,500 x Lesní Troll")'><br>
                        <input value='Dralgar - Zahrady kolem chrámu 2' class='pleneni zelene' type=button onclick='pole("2,000 x Veledruid\n25 x Horský obr\n5 x Horský Wurm\n1,250 x Ent\n1,000 x Starodávný Ent")'><br>
                        <input value='Dralgar - Gigantický chrám 1' class='pleneni zelene' type=button onclick='pole("2,500 x Obří zelený pavouk\n2,500 x Obří červený pavouk\n2,500 x Obří černý pavouk\n1,000 x Zlatý lesní pavouk\n2,500 x Lesní Troll")'><br>
                        <input value='Dralgar - Gigantický chrám 2' class='pleneni zelene' type=button onclick='pole("3,000 x Druid\n50 x Prastarý Horský obr\n10 x Prastarý Horský Wurm\n2,500 x Ent\n2,000 x Starodávný Ent")'><br>
                        <input value='Dralgar - Dralgarova zahrada' class='pleneni zelene' type=button onclick='pole("30,000 x Prastarý Lesní Troll\n20,000 x Obří černý pavouk\n10,000 x Lesní Bizon\n2,000 x Prastarý Horský obr\n1,000 x Zlatý lesní pavouk\n1,000 x Jednorožec\n250 x Prastarý Horský Wurm\n1 x Posvátný jednorožec")'><br>
                ...
                <td>
                    <div id="sekcePleneniOstatni"><a class='nadpisSekce' onclick="simulovatCelouSekci('sekcePleneniOstatni')"><b>Plenění ostatní</b></a><br>
                    ...
                    <div id="sekceDobyvani"><a class='nadpisSekce' onclick="simulovatCelouSekci('sekceDobyvani')"><b>Dobývání</b></a><br>
                ...
                <td>
                    <div id="sekceEventy"><a class='nadpisSekce' onclick="simulovatCelouSekci('sekceEventy')"><b>Eventy</b></a><br>
                ...
                <td>
                    <div id="sekceChramy"><a class='nadpisSekce' onclick="simulovatCelouSekci('sekceChramy')"><b>Eventy - chrámy</b></a><br>
                ...
                <td>
                    <div id="sekceDemoniEventy"><a class='nadpisSekce' onclick="simulovatCelouSekci('sekceDemoniEventy')"><b>Démoní eventy</b></a><br>
                        ...
                        <input value='Obětiště obsazené démony' class='promenneDleSilyArmady' type=button onclick='silaarmady(6)'><br>
                    </div>
                    <br>


                    <div id="sekceDemoni"><a class='nadpisSekce' onclick="simulovatCelouSekci('sekceDemoni')"><b>Démoni</b></a><br>
                    ...
                    <input value='Pevnost démonů 07' type=button
                           onclick='pole("10000 x Otrok s kopím\n10000 x Otrok s oštěpy\n10000 x Otrok štítonoš\n200 x Katapult\n200 x Těžká balista\n40 x Ohnivý imp\n2500 x Následovník démonů - Lidský Odpadlík\n1000 x Následovník démonů - Zasvěcenec\n500 x Následovník démonů - Vyšší Zasvěcenec\n750 x Následovník démonů - Berzeker\n300 x Následovník démonů - Kacíř\n10 x Následovník démonů - Prokletý Berzeker\n100 x Ohnivý démon\n75 x Plamenný démon\n50 x Plamenný démon s bičem\n40 x Plamenný démon mág\n5 x Plamenný démon arcimág\n100 x Démon Křižák\n75 x Démon Těžký Křižák\n50 x Démon Válečník Temnoty\n5 x Démon Bojový Mág Temnoty\n1 x Temný Lord Argon(Amulet velitele)\n1 x Dh Atrog řečený Válečník(Popel padlích válečníků)\n1 x Dh Ratu řečený Posel ohně\n1 x Dh Tog řečený Mág ohně(Ohnivá róba)\n1 x Dh Atog řečený sběratel soch(Hůl silového pole)\n1 x Rah Atrog řečený Vyvolávač(Ohnivá zbroj)\n1 x Ragnarokk, prokletý wurm (Prapor starého druidského cechu)")'><br>
                </td>

                <td>
                    <div id="sekceBonusy"><a class='nadpisSekce' onclick="simulovatCelouSekci('sekceBonusy')"><b>Bonusy</b></a><br>
                    ...
                    <div id="sekceCisarskeArmady"><a class='nadpisSekce' onclick="simulovatCelouSekci('sekceCisarskeArmady')"><b style='color:gray'>Boje o Imperátorův Palác</b></a><br>
                        <input style='color:gray' value='Dralgar 54M 5/2015 (rip001)' type=button
                               onclick='pole("1 x Generál starého impéria (Ohnivá róba)\n1 x Generál starého impéria\n200 x Kapitán elitních střelců starého impéria\n1 x Generál starého impéria (Ohnivá róba)\n200 x Kapitán rytířů starého impéria\n5,000 x Elitní střelec starého impéria\n5,000 x Rytíř starého impéria\n500 x Kapitán střelců starého impéria\n60 x Železný orel - MK1 (Hůlka ledu)\n3,602 x Elfí lučištník (Bronzový meč)\n10,000 x Střelec starého impéria\n155,798 x Elfí elitní lučištník (Težká bojová sekyra)\n1 x Posvátný jednorožec (Kalich ohně)\n20,000 x Elfí hraničář (Prapor krvavého šílenství)\n519 x Jednorožec (Kouzelnická róba)\n50 x Plukovník pěšaků starého impéria\n6 x Prokletý Obr (Prokletá kouzelnická róba)\n1 x Místodržící\n720 x Ohnivý Služebník (Dralgarův Totem života)\n800 x Kapitán pěšáků starého impéria\n4 x Ohnivý Obr\n30 x Plukovník těžkých pěšaků starého impéria\n5 x Ledový obr (Atherův ledový prapor)\n500 x Kapitán těžkých pěšáků starého impéria\n40,000 x Pěšák starého impéria\n20,000 x Těžký pěšák starého impéria\n6,308 x Lesní Bizon (Vulkánův ohnivý prapor)\n1,000 x Železný škopion (Težká bojová sekyra)\n1,080 x Ledový Přízrak (Kalich ohně)\n68,564 x Veledruid (Prapor starého druidského cechu)\n122,520 x Otrok s oštěpy (Dralgarův Totem života)\n204,574 x Žebrák (Kalich ohně)\n5,718 x Odpadlík (Kalich ohně)\n2,601 x Druid (Kalich ohně)\n44 x Lesní obr (Dralgarův Totem života)\n263,030 x Růžové prasátko (Kalich ohně)\n142,620 x Otrok s kopím (Dralgarův Totem života)\n600 x Železný Golem (Tvrzené ocelové pláty)\n200 x Starodávný Ent\n690,457 x Ozbrojený vesničan (Pírko z anděla)\n131,320 x Otrok štítonoš (Dralgarův Totem života)\n27,362 x Hnijící vesničan (Kalich ohně)\n1,135 x Těžká balista (Atherův ledový prapor)\n200 x Poloautomatická socha (Tvrzené ocelové pláty)")'><br>
                        <input style='color:gray' value='Aether 151M 6/2022 (Healtonn)' type=button onclick='pole("1 x Velitel 4 (Æthrova róba moci)\n653,519 x Ozbrojený vesničan (Kalich ohně)\n2 x Těžký katapult\n2 x Těžká balista\n31,270 x Renegád\n828,244 x Æthrův věrný (Kalich ohně)\n94,541 x Ledový válečník (Ætherův ledový prapor)\n16,602 x Sestra Ledu (Ætherův ledový prapor)\n3,500 x Šaman Ledu (Kouzelnická róba)\n47,927 x Æthrův šaman Ledu (Velemágova róba moci)\n100 x Ledová hvězda (Kouzelnická róba)\n870 x Æthrova ledová hvězda (Rukavice drtivé síly)\n251 x Mág ledu (Amulet velitele)\n1 x Velemág Ledu (Amulet Beznaděje)\n17,766 x Sněžný vlk (Kouzelnická róba)\n289,865 x Ledový vlk (Ætherův ledový prapor)\n2,000 x Ohnivý Fénix\n1 x Ledový Fénix (Amulet velitele)\n1,656 x Střelec starého impéria (Hůlka ledu)")'><br>
                        <input style='color:gray' value='Ghoro 138M 6/2022 (Hron)' type=button onclick='pole("1 x Velitel 4 (Ohnivá dračí zbroj)\n192 x Gobliní Vyztužená Vzducholoď (Gnomí vozík)\n11,265,221 x Goblin s Prakem (Težká bojová sekyra)\n11 x Snežný obr (Hůlka ledu)\n113,203 x Žebrák (Kouzelnická róba)\n244,964 x Goblin Pyroman\n1 x Gobliní Patriarcha\n3,793,201 x Goblin (Hůlka ohně)\n1,000 x Gobliní dělo nabité bombou\n7,596,062 x Hobgoblin (Pírka z anděla)\n5,000 x Gobliní dělo nabité fanatikem\n24,360 x Goblin Pyroman Sapér (Hůlka ledu)\n50 x Gobliní Exterminátor (Hůlka ledu)\n1 x Gobliní Hrdina (Ohnivá róba)\n1,200 x Poloautomatická socha (Tvrzené ocelové pláty)\n1 x Prokletý Obr (Prokletá kouzelnická róba)\n60,296 x Goblin Fanatik\n176,344 x Ozbrojený vesničan (Kouzelnická róba)\n398 x Gobliní pojízdná bomba\n1 x Ledový obr (Ætherův ledový prapor)\n157 x Paladin Světla\n1 x Generál starého impéria (Ohnivá róba)\n30,958 x Hnijící vesničan (Kouzelnická róba)")'><br>
                        <input style='color:gray' value='Dhar 577M 6/2022 (Bota)' type=button
                               onclick='pole("1 x Velitel 4 (Æthrova róba moci)\n7,140,635 x Toxický Bahenní Brouk (Kalich ohně)\n887,645 x Bahenní Brouk (Kalich ohně)\n1 x Generál starého impéria (Æthrova róba moci)\n104 x Ledový Fénix\n516 x Rytíř starého impéria\n27 x Elfí lučištník\n429 x Paladin Světla (Kalich ohně)\n13 x Prokletý Obr\n2,670 x Toxický Bahenní Had (Drtič lebek)\n4 x Černý lesní pavouk\n85,581 x Toxický Bahenní Golem (Težká bojová sekyra)\n237 x Bahenní Had (Težká bojová sekyra)\n13,208 x Bahenní Golem\n20 x Kyselý červík\n25 x Ohnivý Obr\n100 x Ohnivý Služebník\n1 x Místodržící\n34 x Snežný obr (Ætherův ledový prapor)\n4,500 x Ohnivý Fénix (Dalekohled)\n1 x Kamenný Kraken (Prokletá kouzelnická róba)\n826 x Voják předsunuté hlídky\n1,072,705 x Toxický Bahenní Ještěr (Težká bojová sekyra)\n15,683 x Renegád\n29,388 x Bahenní Ještěr\n50 x Ledový Přízrak\n8,212 x Toxický Minotaurus (Dharova kamenná standarta)\n6,020 x Těžký pěšák starého impéria (Kouzelnická róba)\n751,008 x Toxický Bahenní Ještěr s kuší (Katana z Temné ocele)\n400 x Minotaurus\n123 x Minotauří Toxický Král Honu (Kalich ohně)\n571,546 x Toxické oživlé bahno\n40 x Horský obr\n200 x Ledový obr\n1,851,918 x Otrok s oštěpy (Težká bojová sekyra)\n40 x Lesní obr\n1,000 x Růžové prasátko\n740 x Obrněný Minotaurus (Dharova kamenná standarta)\n1,817,831 x Otrok s kopím (Kalich ohně)\n10 x Minotauří Král Honu (Kalich ohně)\n50 x Starodávný Ent\n11,220 x Bahenní Ještěr s kuší\n516,923 x Ozbrojený vesničan (Kalich ohně)\n57 x Multinefunkční golem\n155,122 x Oživlé bahno (Měděné pláty)\n50 x Ent\n120 x Skoropoužitelný golem\n1,795 x Těžký katapult (Bastard)\n92 x Nepoužitelný golem\n1,790 x Těžká balista (Ghorova standarta s nabodnutou hlavou démona)\n165,521 x Hnijící vesničan\n1,699,720 x Otrok štítonoš (Tvrzené ocelové pláty)\n50 x Bažinný ent\n274,041 x Žebrák (Ohnivá palisáda)\n16,054 x Obrněný Toxický Minotaurus (Pláty z Temné ocele)")'><br>
                        <input style='color:gray' value='Dreadd 42M 6/2022 (Healtonn)' type=button onclick='pole("1 x Velitel 4 (Ghorova standarta s nabodnutou hlavou démona)\n2 x Těžký katapult\n17 x Elfí lučištník\n94,300 x Zombie (Tvrzené ocelové pláty)\n3,301 x Lich (Kostěná flétna)\n226 x Arcilich (Kostěná flétna)\n1,500 x Stín (Kalich ohně)\n920 x Temný přízrak (Prapor stínů)\n308 x Nekromant (Prokletá kouzelnická róba)\n15,931 x Upír (Kouzelnická róba)\n291,390 x Kostlivec (Prapor stínů)\n1 x Dreaddův Vyvolený (Slonovinový luk)\n857 x Nemrtvý Druid (Kouzelnická róba)\n260 x Nemrtvý ohnivý kouzelník\n661 x Nemrtvý ledový kouzelník\n169 x Zvěstovatel soudného dne\n22 x Obří kostlivec (Prokletá kouzelnická róba)\n198,583 x Ghúl (Dreaddův prapor smrti)\n53 x Ledový Fénix\n1 x Generál starého impéria (Ohnivá róba)\n1 x Generál starého impéria (Ohnivá róba)")'><br>
                        <input style='color:gray' value='Dralgar 292M 6/2022 (Healtonn)' type=button
                               onclick='pole("1 x Velitel 4 (Æthrova róba moci)\n13 x Ledový Fénix (Ætherův ledový prapor)\n1 x Generál starého impéria (Ohnivý bič)\n6,821 x Elfí lučištník (Čepec vyvolávače počasí)\n884,710 x Elfí elitní lučištník (Težká bojová sekyra)\n7,266 x Střelec starého impéria\n1 x Posvátný jednorožec (Æthrova róba moci)\n1 x Prokletý Obr (Prokletá kouzelnická róba)\n650,575 x Elfí hraničář (Bastard)\n1,675 x Jednorožec (Kouzelnická róba)\n167,034 x Černý lesní pavouk (Amulet velitele)\n63 x Obří zelený pavouk\n1 x Ledový obr (Ætherův ledový prapor)\n300 x Zelený lesní pavouk\n1 x Ledový Přízrak\n2,456,292 x Otrok s oštěpy (Čepec vyvolávače počasí)\n5,001 x Ohnivý Fénix (Ghorova standarta s nabodnutou hlavou démona)\n239 x Zlatý lesní pavouk (Ætherův ledový prapor)\n58 x Těžká balista (Ætherův ledový prapor)\n60 x Těžký katapult (Ætherův ledový prapor)\n51,322 x Hnijící vesničan\n2,787 x Horský obr (Ghorova standarta s nabodnutou hlavou démona)\n124,400 x Obří černý pavouk (Dralgarův Totem života)\n861,352 x Ozbrojený vesničan (Kalich ohně)\n216,983 x Žebrák (Totem krve)\n39,434 x Otrok s kopím\n401 x Paladin Světla (Dreaddův prapor smrti)")'><br>
                    </div>
                </td>
            </tr>
        </table>
    ...
    <div id='kontejnerVysledku' class="centeredContainer">
        <div id="loaderGif"></div>
        <div id='simulationResult' style="text-align: left; margin-left: 30px"></div>
    </div>

    <div id='infoSekce' class="centeredContainer" style='width: 1000px; text-align: left'>
        <br>
        ...
        1) Přidat odměny při výhře, 2) Hodnoty min/max armád eventů, 3) Milion dalších v github repozitáři v issues + starší v poznamky/TODO.txt<br>
        Pokud se chce kdokoliv podílet na vylepšování/údržbě simulátoru, je vítán (pište na fórum+mail, viz kontakty)!!! ;-)
        <br>
        <h4>Credits</h4>
