...
<input value='Obři dobra' type=button onclick='pole("50 x Lesní obr\n80 x Ledový obr\n12 x Kamenný Obr")'><br>

<input value='Země zatracených 1' type=button onclick='pole("30000 x Zombie\n1000 x Lich\n30 x Temný přízrak\n500 x Padlý válečník")'><br>

<input value='Země zatracených 2' type=button onclick='pole("2000 x Stín\n12000 x Kostlivec\n10000 x Uvězněná duše\n30 x Temný přízrak\n500 x Padlý válečník")'><br>

<input value='Temný les' type=button onclick='pole("200 x Prokletý Obr")'><br>

<input value='Otrokářská kolonie 1' type=button onclick='pole("100 x Otrokář\n10000 x Otrok s kopím\n10000 x Otrok s oštěpy\n10000 x Otrok štítonoš")'><br>

<input value='Otrokářská kolonie 2' type=button onclick='pole("100 x Otrokář\n50000 x Otrok s kopím")'><br>

<input value='Ledový palác' type=button onclick='pole("1 x Ledový král\n750 x Ledový Přízrak\n750 x Starodávný Ledový Přízrak\n1000 x Ledový Elementál\n100 x Ledový obr")'><br>

<input value='Dralgarova zahrada 1' type=button onclick='pole("2000 x Obří zelený pavouk\n2000 x Červený lesní pavouk\n2000 x Černý lesní pavouk\n400 x Zlatý lesní pavouk\n1000 x Lesní Troll\n")'><br>

<input value='Dralgarova zahrada 2' type=button onclick='pole("2500 x Druid\n50 x Lesní obr\n5 x Wurm\n1250 x Ent\n1000 x Starodávný Ent")'><br>

<input value='Prokletý vojevůdce' type=button onclick='pole("1 x Dehinator (Ohnivá zbroj)\n12 x Těžký katapult\n12 x Těžká balista\n40 x Zeď Temné pevnosti\n300 x Prokletý Mág\n750 x Prokletý válečník(Prapor stínů)\n6 x Dehinatorova ochranka")'><br>

<input value='Prokletá citadela' type=button onclick='pole("1 x Královna Medůz(Maska Královny medůz)\n1000 x Temný mág(Kouzelnická róba)\n200 x Vyšší Temný Mág(Prokletá kouzelnická róba)\n32 x Zeď Prokleté citadely\n200 x Prokletý Mág\n1000 x Prokletý válečník(Prapor stínů)\n3000 x Æthrův ledový válečník")'><br>

<input value='Mucusova pevnost' type=button onclick='pole("1 x Mucus, král Toxických elementálů(Plášť Mucuse, krále toxických elementálů)\n1500 x Zeď pokrytá slizem\n1000 x Toxický Elementál Obránce\n1000 x Toxický Elementál Útočník\n10 x Toxická Elementární Bublina")'><br>

<input style='color:gold' value='Posvátný chrám' type=button onclick='pole("10000 x Svatý válečník\n1500 x Elitní střelec\n1000 x Mnich\n500 x Křižák\n250 x Paladin\n1 x Světlonoš\n25 x Balista\n30 x Těžká balista\n1000 x Renegád")'><br>

<input style='color:olive' value='Gnomí velkodílna' type=button onclick='pleneni(1)'><br>

<input style='color:olive' value='Spolek mocných' type=button onclick='pleneni(2)'><br>

<input style='color:olive' value='Katakomby' type=button onclick='pleneni(3)'><br>

<input style='color:olive' value='Temná jeskyně' type=button onclick='pleneni(4)'><br>

<input value='Trpaslíci 1 - Hlídka u úpatí hor' type=button onclick='pole("370 x Železnej kněz\n8,290 x Trpaslík\n659 x Železnej golem\n16,080 x Železnej pavouček\n728 x Železnej škorpion")'><br>

<input value='Trpaslíci 2 - Strážní věž' type=button onclick='pole("684 x Železnej kněz\n15,032 x Trpaslík\n1,122 x Železnej golem\n29,662 x Železnej pavouček\n1,285 x Železnej škorpion\n418 x Železnej býk")'><br>

<input value='Trpaslíci 3 - Citedela' type=button onclick='pole("1,166 x Železnej kněz\n24,366 x Trpaslík\n1,513 x Kamennej chrlič\n562 x Poloautomatická socha\n145 x Železný orel - MK1\n152 x Obrněnej vrhač oštěpů\n132 x Obrněnej válečnej vůz")'><br>

<input value='Trpaslíci 4 - Železný chrám' type=button onclick='pole("2,003 x Železnej kněz\n45,297 x Trpaslík\n3,992 x Železnej škorpion\n1,305 x Železnej býk\n2,779 x Kamennej chrlič\n921 x Poloautomatická socha\n259 x Železný orel - MK1\n5 x Colosus z temné ocele")'><br>
...
<input style='color:green' value='Malý kmen obrů lidožroutů' type=button onclick='pole("12 x Obr lidožrout")'><br>

<input style='color:green' value='Kmen obrů lidožroutů' type=button onclick='pole("38 x Obr lidožrout")'><br>

<input style='color:green' value='Trosky neznámého chrámu' type=button onclick='silaarmady(7)'><br>

<input style='color:green' value='Prokletý chrám ohně' type=button onclick='silaarmady(8)'><br><br>
...
<input value='Chrám gobliní sekty' type=button onclick='pole("746 x Goblin\n120 x Goblin s Prakem\n20 x Goblin Fanatik\n2 x Gobliní pojízdná bomba\n23 x Goblin Pyroman")'><br>

<input value='Chrám ledu' type=button onclick='pole("105 x Vyznavač boha ledu\n12 x Zasvěcenec boha ledu\n9 x Ledový Přízrak")'><br>

<input value='Svatyně ledu' type=button onclick='pole("1020 x Vyznavač boha ledu\n112 x Zasvěcenec boha ledu\n103 x Ledový Přízrak\n8 x Ledový obr")'><br>

<input value='Dóm ledu' type=button onclick='pole("5,119 x Vyznavač boha ledu\n1,071 x Zasvěcenec boha ledu\n501 x Starodávný Ledový Přízrak\n76 x Ledový obr\n44 x Sněžný obr\n210 x Šaman Ledu")'><br>

<input value='Chrám života' type=button onclick='pole("51 x Ent\n78 x Druid\n1 x Lesní obr")'><br>

<input value='Svatyně života' type=button onclick='pole("582 x Ent\n265 x Starodávný ent\n1000 x Druid\n10 x Lesní obr")'><br>

<input value='Dóm života' type=button onclick='pole("2874 x Ent\n1456 x Starodávný ent\n4766 x Druid\n1,406 x Veledruid\n36 x Lesní obr")'><br>

<input value='Chrám ohně' type=button onclick='pole("573 x Mág ohně\n55 x Ohnivý golem\n10 x Ohnivý Fénix\n1 x Flamekeeper\n")'><br>

<input value='Svatyně ohně' type=button onclick='pole("5154 x Mág ohně\n505 x Ohnivý golem\n80 x Magmatický golem\n90 x Ohnivý Fénix\n12 x Flamekeeper\n")'><br>

<input value='Dóm ohně' type=button onclick='pole("16,653 x Mág ohně\n993 x Magmatický golem\n338 x Ohnivý Fénix\n28 x Flamekeeper\n1 x Magmatický Obr")'><br>

<input value='Ætherův chrám' type=button onclick='pole("2000 x Vyznavač boha ledu\n100 x Zasvěcenec boha ledu\n120 x Ledový Přízrak\n25 x Ledový obr\n3 x Ledová hydra")'><br>

<input value='Ætherova svatyně' type=button onclick='pole("14100 x Vyznavač boha ledu\n3180 x Zasvěcenec boha ledu\n990 x Ledový Přízrak\n612 x Starodávný ledový přízrak\n159 x Ledový obr\n17 x Ledová hydra\n1 x Velemág ledu")'><br>

<input value='Chrám země' type=button onclick='pole("1170 x Elfí lučištník\n118 x Druid\n2 x Wurm\n1102 x Ent\n480 x Starodávný Ent\n2 x Mág země")'><br>

<input value='Posvátný chrám země' type=button onclick='pole("4528 x Elfí lučištník\n558 x Druid\n300 x Veledruid\n5 x Wurm\n2327 x Ent\n1406 x Starodávný Ent\n5 x Mág země")'><br><br>
...
<input style='color:green' value='Démoní karavana' type=button onclick='silaarmady(5)'><br>

<input style='color:green' value='Obětiště obsazené démony' type=button onclick='silaarmady(6)'><br><br>
...
<input style='color:gold' value='Zobrazit klan - Hell' type=button onclick='hraci("hell")'><br>

<input style='color:gold' value='Zobrazit klan - Heaven' type=button onclick='hraci("heaven")'><br>
...
1. V LoI se iniciativa snižuje až na konci kola, zatímco v simulátoru okamžitě. S výjimkou případů, kdy iniciativa klesne na 0 a jednotka pak regulérně nezaútočí. Toto je ovšem bug k opravení na straně loi a ne v simulátoru :P<br><br>



<br><br>

Původním autorem tohoto simulátoru nejsem já (pouze ho již delší dobu vyvíjím a spravuji).
V případě, že narazíte na chybu, napiště mi prosím email: mengsk@email.cz
