...
<body bgcolor='#000000' text='#f5f5f5' link='#b0c4de' vlink='#b0c4de' alink='#b0c4de' topmargin='0'>
	...
	foreach ($xml->jednotka as $jednotka) {
		...
		foreach ($jednotka->schopnosti->schopnost as $schopnost) {
			...
			} elseif ($nazevSchopnosti == "imunitaMagie") {
			...
			} elseif ($nazevSchopnosti == "magieLesa" and $hodnotaSchopnosti == 5) {
			...
			} elseif ($nazevSchopnosti == "magieZeme" and $hodnotaSchopnosti == 1) {
			...
			} elseif ($nazevSchopnosti == "magieZeme" and $hodnotaSchopnosti == 2) {
			...
			} elseif ($nazevSchopnosti == "magieLedu" and ($hodnotaSchopnosti == 1)) {
			...
			} elseif ($nazevSchopnosti == "magieLedu" and $hodnotaSchopnosti == 2) {
			...
			} elseif ($nazevSchopnosti == "magieLedu" and $hodnotaSchopnosti == 3) {
			...
			} elseif ($nazevSchopnosti == "magieLedu" and $hodnotaSchopnosti == 4) {
			...
			} elseif ($nazevSchopnosti == "magieSmrti" and $hodnotaSchopnosti == 2) {
			...
			} elseif ($nazevSchopnosti == "magieSmrti" and $hodnotaSchopnosti == 3) {
			...
			} elseif ($nazevSchopnosti == "magieSmrti" and $hodnotaSchopnosti == 4) {
			...
			} elseif ($nazevSchopnosti == "magieSmrti" and $hodnotaSchopnosti == 7) {
				echo "<img src='images/magie_smrt_7.jpg' alt='Magie smrti 7' title='Magie smrti 7 - Jednotka dokáže přivolat Prokleté enty.'> ";
			} elseif ($nazevSchopnosti == "magieSmrti" and $hodnotaSchopnosti == 8) {
			...
			} elseif ($nazevSchopnosti == "magieSmrti" and $hodnotaSchopnosti == 9) {
			...
			} elseif ($nazevSchopnosti == "magieSmrti" and $hodnotaSchopnosti == 10) {
				echo "<img src='images/neni.gif' alt='Magie smrti 10' title='Magie smrti 10 - Jednotka přivolá 300 až 800 Uvězněných duší.'> ";
			} elseif ($nazevSchopnosti == "magieSmrti" and $hodnotaSchopnosti == 11) {
			...
			} elseif ($nazevSchopnosti == "magieSmrti" and $hodnotaSchopnosti == 12) {
			...
			} elseif ($nazevSchopnosti == "magieSmrti" and $hodnotaSchopnosti == 13) {
			...
			} elseif ($nazevSchopnosti == "magieSvetla" and $hodnotaSchopnosti == 1) {
			...
			} elseif ($nazevSchopnosti == "magieSvetla" and $hodnotaSchopnosti == 2) {
			...
			} elseif ($nazevSchopnosti == "magieSvetla" and $hodnotaSchopnosti == 3) {
				$hodnotaSchopnosti = getLightMagicValue($jednotka);
			...
			} elseif ($nazevSchopnosti == "magieSvetla" and $hodnotaSchopnosti == 4) {
				$hodnotaSchopnosti = getLightMagicValue($jednotka);
			...
			} elseif ($nazevSchopnosti == "magieSvetla" and $hodnotaSchopnosti == 5) {
			...
			} elseif ($nazevSchopnosti == "ohnivyStit") {
			...
			} elseif ($nazevSchopnosti == "ledovyStit") {
			...
			} elseif ($nazevSchopnosti == "toxickyStit") {
			...
			} elseif ($nazevSchopnosti == "drtivyUtok") {
			...
			} elseif ($nazevSchopnosti == "svatyUtok") {
			...
			} elseif ($nazevSchopnosti == "jedovyUtok") {
			...
			} elseif ($nazevSchopnosti == "imunitaOhen") {
			...
			} elseif ($nazevSchopnosti == "temnykrik") {
			...
			} elseif ($nazevSchopnosti == "vzkryseni") {
			...
			} elseif ($nazevSchopnosti == "magieEternanu" and $hodnotaSchopnosti == 1) {
				echo "<img src='images/neni.gif' alt='Eternanská magie 1' title='Eternanská magie 1'> ";
			} elseif ($nazevSchopnosti == "magieEternanu" and $hodnotaSchopnosti == 2) {
			...
			} elseif ($nazevSchopnosti == "vyvolavaJednotku" and $jednotka->nazev == "Gobliní Vyztužená Vzducholoď") {
			...
			} elseif ($nazevSchopnosti == "silaGoblinu") {
