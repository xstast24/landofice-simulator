Unit parser contains html files for generating new units from provided HTML table
...
Files jednotky_id.txt and unit_id_generator are temporary and for now serve no purpose
